...
class TestScene(Scene):
    def __init__(self, engine: LunaEngine):
        ...
        self.add_ui_element(Button(350, 100, 200, 100, 'Test', 32))
    ...
    def render(self, renderer: OpenGLRenderer):
        ...
        renderer.draw_polygon(points, style=style_rect_gradient)
        
        # ---- ISOSCELES TRIANGLE (right column, third row) ----
        renderer.draw_text('Isosceles Triangle', 620, 340, (255, 200, 200), FontManager.get_font(None, 24))
        renderer.draw_isosceles_triangle(650, 370, 120, 80, style=style_rect_gradient)
        
        # ---- EQUILATERAL TRIANGLE (right column, fourth row) ----
        renderer.draw_text('Equilateral Triangle', 620, 500, (255, 200, 200), FontManager.get_font(None, 24))
        renderer.draw_equilateral_triangle(680, 530, 100, style=style_rect_gradient)
