...
DESCRIPTION:
Demonstrates the SpriteSheet, Animation, and Image systems:
...
- Preview includes a cached Image variant with normalized scale and alpha
"""
...
class SpriteSheetTestScene(Scene):
    ...
    def __init__(self, engine: LunaEngine):
        ...
        self.raw_image = None          # Image wrapper around the same frame
        self.image_variant = None      # cached, filtered Image variant
    ...
    def load_animations(self):
        ...
        try:
            ...
            self.raw_image = self.sprite_sheet.get_image_at_rect(self.raw_frame_rect)
            self.image_variant = (self.raw_image.copy()
                                  .set_scale(1.25)
                                  .set_alpha(0.9)
                                  .set_filter("tint", color=(170, 210, 255), intensity=0.35))
    ...
    def create_placeholder_animations(self):
        ...
        self.raw_image = Image(self.raw_frame)
        self.image_variant = self.raw_image.copy().set_scale(1.25).set_alpha(0.9)
    ...
    def update_preview(self):
        ...
        if effect == "Original" and self.image_variant is not None:
            frame = self.image_variant.get_surface()
        else:
