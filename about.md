...
| --- | --- |
| **`backend/`** | This is where the engine gets down to the nitty-gritty, handling low-level bindings and direct hardware communication. Think OpenGL, OpenAL, and getting cozy with your controller inputs. It’s the unsung hero making everything tick. |
...
- **Total codebase**: Roughly 64 files, spanning over 25,000 lines of Python code.

- **Themes**: A delightful collection of 72+ pre-built themes, ready to give your UI a fresh look.

- **UI Elements**: 30 distinct UI elements, from humble buttons to complex widgets, all ready for your creative touch.
...
- **Themes Galore**: With over **72+** pre-made themes, you can effortlessly style your game’s UI to match any aesthetic. It’s like having a wardrobe full of outfits for your game!
